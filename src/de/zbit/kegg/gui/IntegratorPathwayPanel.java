...
public class IntegratorPathwayPanel extends TranslatorGraphPanel implements SpeciesHolder {
  ...
  /**
   * The label holding enrichment information of the detail panel.
   */
	private JLabel label;
	/**
	 * The table holding enrichment information of the detail panel.
	 */
            ...
            for (Map.Entry<VisualizedData,Collection<?>> e : data.entrySet()) {
              ...
              if (ns!=null && ns.size()>0) {
                ...
                if (signals!=null && signals.size()>0) {
                  ...
                  // If the text of the label is changed, also change label text in updateDetailPanelEnrichmentValues
