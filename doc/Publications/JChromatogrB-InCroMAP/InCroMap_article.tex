...
metabolomics platforms allow to investigate complex metabolite patterns with high accuracy. \red{In recent years, increasing attention has been drawn to the integration of metabolomics with molecular profiling on the transcriptional and protein level \cite{Gruden2012, Amiour2012}.}
