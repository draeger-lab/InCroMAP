...
%For example, with this procedure one can define that all probes within -2000 and +500 bps of a TSS are most important for the regulation of this gene's expression.
...
% - und kurze interpretation eines finalen bildes liefern ("man sieht in einem bild pathway informationen, miRNA relationen, expressionsdaten von miRNA, mRNA, bla; und sonst ist meist nach dem enrichment schluss bzw mRNA einfarbung bereits das maximum moegliche").
