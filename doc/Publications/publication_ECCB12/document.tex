...
were mostly limited to mRNA transcripts, the vast majority of visualization tools is focused
...
modifications such as DNA methylation can be monitored on a genome-wide level using
...
\citep[see][for some examples]{Gehlenborg2010}. However, the current inventory of publicly available tools that are capable of
...
% Bezieht sich auf KEGG metabolic pathways und ist deshalb auskommentiert
%This feature also enhances the visualization of the global maps in KEGG PATHWAY, as additional information on the organisation of subordinate pathway groups is provided by the pathway image.
...
% Single-platform Visualisierung ist einfach
