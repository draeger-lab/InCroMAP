...
% TODO Clemens: Umformulieren mit GraphML format? yWorks raus? usw.
...
% TODO: Diskussionspunkt: Alternativ zu Abbildung auf Targets wäre auch Abbildung auf Genlokus denkbar (Heidruns Vorschlag)
...
As a matter of fact, this assumption does not hold for the DNA-methylation of promoter regions, which
is for one not expected to be evenly distributed along the region. Secondly, outlier probes corresponding to 
...
as it is sensitive to local changes in DNA-methylation. Alternatively, we suggest to use the mean 
