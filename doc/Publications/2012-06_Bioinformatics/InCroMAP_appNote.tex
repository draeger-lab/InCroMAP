...
% deutlich weniger für miRNA, DNAm oder protein [mod.]
%
% Wir präsentieren InCroMAP, was h-level single dataset analysis kann, enrichments, visualisierung (DNAm), miRNA targets, pathway-visualisierung, uvm.
...
%Keine alternative (kein fold-change berechnen, Clustering, MA plot) sondern ergänzend und darauf aufbauende analysen, insbesondere für integrated.
...
%Für miRNA gut, AbsoluteSum kann berechnet werden um jede zu bekommen welche in protein und mRNA hochreguliert sind.
...
%Multiple Integration für mehrere, hierbei infos auf wunsch erst aufklappen.
%Integrated Enrichment
%PW-based visualization
%DNAm-region + mRNA färbung unten
